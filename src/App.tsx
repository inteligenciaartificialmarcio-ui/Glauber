    ...
    <main id="inicio" className="relative min-h-screen selection:bg-gold-500/30">
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[999] md:hidden bg-black overscroll-none h-[100dvh] touch-none"
          >
            {/* Backdrop */}
            <div 
              className="absolute inset-0 bg-black h-full w-full touch-none"
            ...
            <motion.div
              ...
              className="fixed inset-0 w-full h-[100dvh] flex flex-col items-center justify-center gap-10 p-10 bg-black z-[1000] touch-none"
            >
              <button 
                onClick={() => setIsMobileMenuOpen(false)}
